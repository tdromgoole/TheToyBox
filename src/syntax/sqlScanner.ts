...
export const SQL_KEYWORDS = new Set([
	...
	// DDL
	"create", "alter", "drop", "use", "enable", "disable", "rename",
	// TCL
	"commit", "rollback", "transaction", "tran", "savepoint", "save",
	// Control flow
	"if", "else", "while", "case", "when", "then", "return", "break",
	"continue", "goto", "try", "catch", "throw", "raiserror", "print", "go",
	"begin", "end",
	// T-SQL procedural
	"declare", "set", "exec", "execute", "output", "inserted", "deleted",
	"nocount", "identity", "procedure", "proc", "function", "trigger",
	"view", "table", "index", "database", "schema", "constraint",
	"primary", "foreign", "key", "references", "default", "unique",
	"check", "with", "nolock", "tablock", "rowlock", "holdlock", "readpast",
	"apply", "pivot", "unpivot", "over", "partition",
	"rows", "range", "unbounded", "preceding", "following", "current", "row",
	"fetch", "next", "first", "last", "only", "offset", "ties", "percent", "top",
	"grant", "revoke", "deny", "login", "user", "role",
	// Clause keywords
	"from", "where", "join", "inner", "outer", "left", "right", "full",
	"cross", "on", "group", "order", "by", "having", "union", "all",
	"distinct", "into", "values", "as", "between", "like", "not",
	"and", "or", "is", "null", "exists", "any", "some", "in",
]);
...
export const SQL_TYPES = new Set([
	...
	"datetimeoffset", "timestamp", "rowversion",
	"uniqueidentifier", "cursor", "xml", "sql_variant",
	"hierarchyid", "geography", "geometry", "sysname",
]);

export const SQL_FUNCTIONS = new Set([
	// Aggregate
	"avg", "count", "max", "min", "sum", "stdev", "stdevp", "var", "varp",
	"string_agg", "count_big", "grouping", "grouping_id",
	// String
	"ascii", "char", "charindex", "concat", "concat_ws", "format",
	"left", "len", "lower", "ltrim", "nchar", "patindex", "quotename",
	"replace", "replicate", "reverse", "right", "rtrim", "soundex",
	"space", "str", "string_escape", "string_split", "stuff", "substring",
	"translate", "trim", "unicode", "upper",
	// Date / time
	"dateadd", "datediff", "datediff_big", "datefromparts", "datename",
	"datepart", "datetime2fromparts", "datetimefromparts",
